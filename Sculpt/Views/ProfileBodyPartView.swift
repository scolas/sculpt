//
//  ProfileBodyPartView.swift
//  Sculpt
//
//  Created by Scott Colas on 6/17/21.
//

import UIKit

class ProfileBodyPartView: UICollectionReusableView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout  {
    static let identifier = "ProfileBodyPartView"
